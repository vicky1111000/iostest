...
- (void)enableLogging {
    ...
    "var console = { "
    "   log: function(data) { "
    "      median.webconsolelogs.print({ data, type: 'console.log' }) "
    "   }, "
    "   error: function(data) { "
    "      median.webconsolelogs.print({ data, type: 'console.error' }) "
    "   }, "
    "   warn: function(data) { "
    "      median.webconsolelogs.print({ data, type: 'console.warn' }) "
    "   }, "
    "   debug: function(data) { "
    "      median.webconsolelogs.print({ data, type: 'console.debug' }) "
    "   }, "
    "}; "
    " ";
